...
public class Config  {
    ...
    // ******
    // Word Pyramid config settings
    // ******
    public static int MAX_WORD_LENGTH = 18;
    public static int PYRAMID_CELL_LENGTH = 60;
    public static int PYRAMID_CELL_HEIGHT = 60;
    public static String PYRAMID_HTMLFILE_PATH = "Pyramid.html";
